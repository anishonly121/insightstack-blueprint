  ...
  return (
    <main className="min-h-screen bg-[#050B18] px-4 py-16 text-white sm:px-6">
      <div className="mx-auto max-w-5xl">
        ...
        <div className="mt-20">
          ...
          <div className="grid gap-6 sm:grid-cols-2">
            {[
              ...
              <div key={q} className="rounded-xl border border-white/6 bg-zinc-900 p-5">
                <p className="mb-2 font-bold text-zinc-100">{q}</p>
        ...
        {/* CTA */}
        <div className="mt-20 rounded-2xl border border-blue-500/15 bg-gradient-to-r from-blue-500/8 to-transparent p-10 text-center">
