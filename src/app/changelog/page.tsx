...
const VERSIONS: Version[] = [
  ...
  },
  {
    ...
    changes: [
      ...
      { type: "added",    text: "PII redaction before OpenAI — strips email, phone, NRIC, long digit strings" },
      { type: "added",    text: "MetricSnapshot caching — 1-hour TTL on dashboard analytics" },
      { type: "added",    text: "Prompt hash cache — identical transaction sets skip the OpenAI call entirely" },
  ...
  },
  {
    ...
    changes: [
      ...
      { type: "added",    text: "OpenAI GPT-4o insights — structured JSON output, Zod validation, local fallback if AI fails" },
