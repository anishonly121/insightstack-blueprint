        ...
        <div className="mx-auto max-w-3xl">
          <Reveal>
            <div className="flex flex-col items-center gap-6 text-center sm:flex-row sm:text-left">
              <div className="flex h-16 w-16 shrink-0 items-center justify-center rounded-2xl bg-gradient-to-br from-blue-500 to-violet-600 text-2xl font-black text-white shadow-[0_0_30px_rgba(99,102,241,0.4)]">
                AB
              </div>
              <div>
                <p className="mb-1 text-lg font-black text-white">Built by Anish Bhole</p>
                <p className="mb-3 text-sm leading-relaxed text-zinc-500">
                  Full-stack software engineer. I built InsightStack because I wanted a finance tool
                  that analysed my spending without asking for my bank credentials. This is
                  the codebase I&apos;d want to find if I were evaluating a candidate.
                </p>
                <div className="flex flex-wrap items-center justify-center gap-3 sm:justify-start">
                  <a
                    ...
                    className="flex items-center gap-2 rounded-lg border border-blue-500/20 bg-blue-500/8 px-4 py-2 text-sm font-semibold text-blue-400 transition hover:border-blue-500/40 hover:bg-blue-500/15"
                  >
                  ...
                  <a
                    href="https://github.com/anishonly121"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="flex items-center gap-2 rounded-lg border border-white/8 px-4 py-2 text-sm font-semibold text-zinc-400 transition hover:border-white/15 hover:text-white"
                  >
                    <svg className="h-4 w-4" fill="currentColor" viewBox="0 0 24 24">
